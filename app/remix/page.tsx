              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-[#2DE2FF]/30 rounded-lg bg-[#14141e] text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-indigo-600 file:text-white hover:file:bg-indigo-700"
                  />
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {images.map((img, index) => (
                        <div key={img.id} className="relative group">
                          <div className="relative aspect-square rounded-lg overflow-hidden border-2 border-[#2DE2FF]/20">
                            <Image
                              src={img.preview}
                              alt={img.name}
                              fill
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 p-3 border border-[#2DE2FF]/30 rounded-lg bg-[#14141e] text-white placeholder-gray-500 focus:border-indigo-500 focus:outline-none resize-none"
              ...
              {generatedImages.length > 0 ? (
                <div className="space-y-6">
                  {generatedImages.map((image, index) => (
                    <div
                      key={image.id}
                      className="bg-[#1a1a24] border border-[#2DE2FF]/20 rounded-lg overflow-hidden shadow-lg"
                    >
                ...
                <div className="text-center py-20 bg-[#1a1a24] border border-[#2DE2FF]/20 rounded-lg">
