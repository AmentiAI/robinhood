...
export default function OwnerMintInterface({ collectionId, totalSupply, mintedCount }: OwnerMintInterfaceProps) {
  return (
    <div className="space-y-6">
      <div className="bg-[#131318] rounded-2xl  border border-[#2DE2FF]/30 rounded-xl p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-[#131318] rounded-2xl  border border-[#2DE2FF]/20 rounded-lg p-4">
            <div className="text-zinc-500 text-sm">Total Supply</div>
            <div className="text-white text-2xl font-bold">{totalSupply}</div>
          </div>
          <div className="bg-[#131318] rounded-2xl  border border-[#2DE2FF]/20 rounded-lg p-4">
            <div className="text-zinc-500 text-sm">Minted</div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#131318] rounded-2xl  border border-[#2DE2FF]/30 rounded-lg text-white placeholder:text-white/50 font-mono text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              defaultValue="1"
              className="w-full px-4 py-3 bg-[#131318] rounded-2xl  border border-[#2DE2FF]/30 rounded-lg text-white"
            />
          ...
          <button
            className="w-full px-6 py-3 bg-[#2DE2FF] hover:bg-[#2DE2FF] text-white font-semibold rounded-lg transition-colors"
            disabled
          >
