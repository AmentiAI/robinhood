    ...
    <div className="min-h-screen bg-gradient-to-br from-[#4561ad] via-[#5a7bc4] to-[#e27d0f]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          {/* 50% Discount */}
          <div className="bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md rounded-2xl p-8 shadow-2xl text-center border border-[#2DE2FF]/30">
            <div className="text-6xl mb-4">💰</div>
            <h2 className="text-3xl font-black text-[#2DE2FF] mb-2">50% OFF</h2>
          ...
          <div className="bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md rounded-2xl p-8 shadow-2xl text-center border border-[#2DE2FF]/30">
            <div className="text-6xl mb-4">🎫</div>
            <h2 className="text-3xl font-black text-[#2DE2FF] mb-2">Whitelist</h2>
        ...
        <div className="bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md rounded-2xl p-6 mb-8 border border-[#2DE2FF]/30">
          <h2 className="text-2xl font-black text-white mb-4 text-center">How It Works</h2>
          <div className="flex justify-center gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#2DE2FF] text-white rounded-full flex items-center justify-center font-black text-xl mx-auto mb-2 shadow-lg shadow-[#2DE2FF]/20">1</div>
              <p className="text-sm font-semibold text-white">Hold Pass</p>
            </div>
            <div className="text-white/50 text-2xl">→</div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#2DE2FF] text-white rounded-full flex items-center justify-center font-black text-xl mx-auto mb-2 shadow-lg shadow-[#2DE2FF]/20">2</div>
              <p className="text-sm font-semibold text-white">Connect Wallet</p>
            </div>
            <div className="text-white/50 text-2xl">→</div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#2DE2FF] text-white rounded-full flex items-center justify-center font-black text-xl mx-auto mb-2 shadow-lg shadow-[#2DE2FF]/20">3</div>
        ...
        <div className="text-center">
          <Link
            href="/buy-credits"
            className="inline-block px-10 py-5 bg-[#2DE2FF] text-white font-black text-xl rounded-xl hover:bg-[#2DE2FF] hover:shadow-2xl transition-all duration-200 shadow-lg shadow-[#2DE2FF]/20"
          >
            Get 50% Off Credits →
          </Link>
        </div>
