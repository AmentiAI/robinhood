                      ...
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-lg border transition-all duration-200 ${
                          selectedTicket?.id === ticket.id
                            ...
                            : 'border-gray-800 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90/50 hover:border-[#2DE2FF]/20'
                        }`}
                      >
                  ...
                  <div className="p-6 border-b border-gray-800">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <select
                        ...
                        className="px-3 py-1 bg-[#1a1a24] border border-[#2DE2FF]/20 rounded-lg text-white text-sm"
                      >
                  ...
                  <form onSubmit={handleSendMessage} className="p-6 border-t border-gray-800">
                    <div className="flex gap-2">
                      <textarea
                        ...
                        className="flex-1 border border-[#2DE2FF]/20 rounded-lg px-4 py-3 bg-slate-950/50 text-gray-100 placeholder-gray-500 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 focus:outline-none resize-none"
