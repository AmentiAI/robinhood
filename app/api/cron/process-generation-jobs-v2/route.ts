...
async function processJob(
  ...
  try {
    ...
    // Build prompt from traits (shared builder — facing/PFP/body settings normalized)
    prompt = buildGenerationPrompt(collection, selectedTraits);

    console.log(`[Cron] Generated prompt for job ${jobId}`, {
