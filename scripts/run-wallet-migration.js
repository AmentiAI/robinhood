/**
 * Script to run the wallet_address migration
 * Usage: node scripts/run-wallet-migration.js
 */
...
async function runMigration() {
  try {
    console.log('📊 Applying wallet_address migration...\n');
    
    const migrationPath = join(__dirname, 'migrations', '017_add_wallet_address.sql');
    ...
    console.log('📝 Wallet address columns and indexes have been added.\n');
