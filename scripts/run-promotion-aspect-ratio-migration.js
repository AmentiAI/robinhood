/**
 * Script to run the promotion aspect ratio migration
 * Adds aspect_ratio column to promotion_jobs and promotions tables
 * Usage: node scripts/run-promotion-aspect-ratio-migration.js
 */
...
async function runMigration() {
  try {
    console.log('📊 Applying promotion aspect ratio migration...\n');
    
    const migrationPath = join(__dirname, 'migrations', '042_add_promotion_aspect_ratio.sql');
    ...
    console.log('📝 aspect_ratio column has been added to promotion_jobs table.');
    console.log('📝 aspect_ratio column has been added to promotions table.\n');
