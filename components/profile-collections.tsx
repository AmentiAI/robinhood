    ...
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <Link
          ...
          className="px-4 py-2 bg-[#2DE2FF] hover:bg-[#2DE2FF] text-white rounded-lg font-semibold transition-colors text-sm shadow-lg shadow-[#2DE2FF]/20"
        >
          Create Collection
        </Link>
      </div>
      ...
      {collections.length === 0 ? (
        <div className="text-center py-8 text-white/70">
          ...
          <Link
            href="/collections/create"
            className="text-[#2DE2FF] hover:text-[#2DE2FF] mt-2 inline-block"
          >
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2 ml-4">
                  <Link
                    ...
                    className="px-3 py-1 text-sm bg-[#2DE2FF] hover:bg-[#2DE2FF] text-white rounded font-semibold transition-colors"
                  >
                    View
                  </Link>
                  <Link
                    href={`/collections/${collection.id}/edit`}
                    className="px-3 py-1 text-sm bg-[#DC1FFF] hover:bg-[#2DE2FF] text-white rounded font-semibold transition-colors"
                  >
                    Edit
                  </Link>
                </div>
