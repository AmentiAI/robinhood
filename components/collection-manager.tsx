      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="bg-[#39FF14] text-white px-4 py-2 rounded hover:bg-[#00C805] text-sm shadow-lg shadow-[#39FF14]/20 transition-colors"
          >
            Advanced Management
          </Link>
          <button
            onClick={() => setShowCreateForm(true)}
            className="bg-[#39FF14] text-white px-4 py-2 rounded hover:bg-[#00C805] shadow-lg shadow-[#39FF14]/20 transition-colors"
          >
            Create Collection
          </button>
        </div>
        ...
        {collections.map((collection) => (
          <div
            ...
            className={`border rounded-lg p-4 ${
              collection.isActive 
                ? 'border-[#39FF14] bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md' 
                : 'border-[#39FF14]/30 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md'
            }`}
          >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-3 py-1 text-sm rounded transition-colors ${
                    collection.isActive
                      ? 'bg-[#39FF14] text-white shadow-lg shadow-[#39FF14]/20'
                      : 'bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md border border-[#39FF14]/30 text-white/70 hover:border-[#39FF14]/50 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className="px-3 py-1 text-sm bg-[#DC1FFF] text-white rounded hover:bg-[#00C805] shadow-lg shadow-[#DC1FFF]/20 transition-colors"
                >
                  Edit
                </button>
                <button
...
function CollectionForm({ availableTraits, traitDescriptions, collection, onSave, onCancel }: CollectionFormProps) {
  ...
  return (
            <div className="border rounded-lg p-6 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md border-[#39FF14]/30">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full border border-[#39FF14]/30 rounded px-3 py-2 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md text-white placeholder-white/50 focus:border-[#39FF14] focus:ring-2 focus:ring-[#39FF14]/20 focus:outline-none"
        ...
        <div className="flex gap-2 pt-4">
          ...
          <button
            onClick={onCancel}
            className="bg-gradient-to-r from-[#39FF14] to-[#DC1FFF] hover:from-[#00C805] hover:to-[#00C805] text-white px-4 py-2 rounded shadow-lg shadow-[#39FF14]/20 transition-all duration-200"
          >
            Cancel
          </button>
        </div>
...
function TraitCategorySelector({ 
  ...
  return (
    <div className="border rounded-lg p-4 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md border-[#39FF14]/30">
      <div className="flex items-center justify-between mb-3">
        <label className="flex items-center space-x-2">
          <input
            ...
            className="rounded bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md border-[#39FF14]/30 text-[#39FF14] focus:ring-[#39FF14]"
          />
        ...
        {selection.enabled && (
          <div className="flex gap-2">
            <button
              onClick={onSelectAll}
              className="text-xs bg-[#39FF14] text-white px-2 py-1 rounded hover:bg-[#00C805] shadow-lg shadow-[#39FF14]/20 transition-colors"
            >
              Select All
            </button>
            <button
      ...
      {selection.enabled && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-60 overflow-y-auto">
          {categoryTraits.map((trait) => {
            ...
            return (
              <label key={trait} className="flex items-start space-x-3 p-2 rounded border border-[#39FF14]/30 hover:bg-[#39FF14]/10 cursor-pointer bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md">
                <input
                  type="checkbox"
                  checked={selection.selected.includes(trait)}
                  onChange={() => onToggleTrait(trait)}
                  className="rounded mt-1 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#00C805]/20 backdrop-blur-md border-[#39FF14]/30 text-[#39FF14] focus:ring-[#39FF14]"
                />
