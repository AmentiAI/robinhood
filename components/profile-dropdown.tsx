...
export function ProfileDropdown() {
  ...
  return (
    ...
    >
      <Link
        href="/profile"
        className="px-3 xl:px-4 py-2 text-xs xl:text-sm font-medium text-[#2DE2FF] hover:text-[#2DE2FF] hover:bg-[#2DE2FF]/10 rounded-lg transition-all duration-200 whitespace-nowrap flex items-center gap-1 relative bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md border border-[#2DE2FF]/30"
      >
        Profile
      ...
      {isOpen && (
        <div 
          className="absolute right-0 mt-1 w-48 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md border border-[#2DE2FF]/30 rounded-lg shadow-2xl z-[9999] overflow-hidden"
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          <div className="py-1">
