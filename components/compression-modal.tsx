...
export function CompressionModal({ isOpen, ordinal, sliderValue, onClose, onSliderChange }: CompressionModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md border border-[#2DE2FF]/30 rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-auto"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-4 border-b border-[#2DE2FF]/30 flex justify-between items-center">
        ...
        <div className="p-6">
          ...
          <div className="relative bg-[#0a0e27] rounded-lg overflow-hidden border border-[#2DE2FF]/20" style={{ aspectRatio: '1/1', maxHeight: '80vh' }}>
                ...
                <>
                  ...
                  >
                    ...
                    {ordinal.original_size_kb != null && (
                      <div className="absolute bottom-4 right-4 bg-[#2DE2FF]/90 text-white text-sm px-3 py-1.5 rounded font-semibold">
                        Original: {(() => {
                  ...
                  {/* Slider Handle */}
                  <div
                    className="absolute top-0 bottom-0 w-2 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md border-l-4 border-r-4 border-[#2DE2FF] cursor-ew-resize z-10 shadow-lg"
                    style={{
                      left: `${sliderValue}%`,
                  ...
                  >
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-[#2DE2FF] rounded-full border-4 border-[#0a0e27] shadow-lg flex items-center justify-center">
                  ...
                  {/* Labels */}
                  <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-[#14141e]/90 to-[#1a1a24]/90 rounded-2xl border border-[#2DE2FF]/20 backdrop-blur-md border-2 border-[#2DE2FF]/30 text-white text-base px-4 py-2 rounded flex gap-4 z-20 shadow-lg">
                    <span className={sliderValue < 50 ? 'font-bold text-[#2DE2FF]' : 'text-white/70'}>
                      ← Compressed
                    </span>
                ...
                <>
                  ...
                  <div className="absolute inset-0">
                    <Image
                      ...
                      className="object-contain"
                    />
                    <div className="absolute top-4 left-4 bg-[#2DE2FF]/90 text-white text-sm px-3 py-1.5 rounded font-semibold">
                      Original Image
                    </div>
                    {ordinal.original_size_kb != null && (
                      <div className="absolute bottom-4 left-4 bg-[#2DE2FF]/90 text-white text-sm px-3 py-1.5 rounded font-semibold">
                        Size: {(() => {
                          const size = Number(ordinal.original_size_kb)
                          return isNaN(size) ? '0.0' : size.toFixed(1)
                        })()} KB
